// by ALIAS & Modified for MP by NovaLogic
params ["_ufo","_radius","_typ_crop"];
cropping_encounter_running = false;
...
NOVA_FNC_cropping_fx = {
    if (!cropping_encounter_running) then {
        params ["_ufo","_radius","_typ_crop"];
        cropping_encounter_running = true;
        enableCamShake true;
        sleep 5;
        sunet_ini = nil;
        ...
        sleep 1.3;
        _orb_obj = "#lightpoint" createVehicle [0,0,0];
        ...
        sleep 0.3;
        _blast_wave = "#particlesource" createVehicle getPosATL _ufo;
...
[_ufo,_radius,_typ_crop] remoteExec ["NOVA_FNC_cropping_fx", 0, true];
/*  */
