/*
Function: JA_World_fnc_randomMarkerID
...
Examples:
    (begin example)
        [] call JA_World_fnc_randomMarkerID;
    (end)
    (begin example)
        ["SHZ_safezone_"] call JA_World_fnc_randomMarkerID;
    (end)
...
for "_i" from 1 to 100 do {
    private _id = format ["%1%2", _prefix, [6] call JA_World_fnc_randomString];
