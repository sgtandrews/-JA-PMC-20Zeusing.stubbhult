/*
Function: JA_World_fnc_inAreaMarkers
...
Examples:
    (begin example)
        [player, "SHZ_someMarker"] call JA_World_fnc_inAreaMarkers;
    (end)
...
private _allMatches = [];
{
    ...
    if !([_x, _prefix] call JA_World_fnc_stringStartsWith) then {continue};
