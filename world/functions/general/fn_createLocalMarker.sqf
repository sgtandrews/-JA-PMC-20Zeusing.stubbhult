/*
Function: JA_World_fnc_createLocalMarker
...
Parameters:
    Array randomMarkerIDParams:
        Parameters to use for JA_World_fnc_randomMarkerID.
...
Examples:
    (begin example)
        [[], [0,0,0]] call JA_World_fnc_createLocalMarker;
    (end)
    (begin example)
        [["SHZ_safezone_"], [0,0,0]] call JA_World_fnc_createLocalMarker;
    (end)
...
private _marker = "";
isNil {
    _marker = _randomMarkerIDParams call JA_World_fnc_randomMarkerID;
