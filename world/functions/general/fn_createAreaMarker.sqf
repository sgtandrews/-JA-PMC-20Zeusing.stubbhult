/*
Function: JA_World_fnc_createAreaMarker
...
Examples:
    (begin example)
        [[], [[0,0,0], 100, 100, 0, false]] call JA_World_fnc_creaAreaMarker;
    (end)
...
private _marker = [_randomMarkerIDParams, _center] call JA_World_fnc_createLocalMarker;
