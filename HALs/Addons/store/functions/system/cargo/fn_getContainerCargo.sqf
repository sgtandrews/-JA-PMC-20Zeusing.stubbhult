...
private _uniqueContainers = [];
{

_uniqueContainers pushBackUnique _x;	

}forEach _containerClassNames;

{	
	private _amount = 0;
	private _containerName = _x;
	_amount = {_containerName == _x }count _containerClassNames;
	//_items pushBack [_containerName,_amount];
	
}forEach _uniqueContainers;
