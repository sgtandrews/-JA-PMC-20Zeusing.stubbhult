...
_trigger_array          = [debugZone,ShootingRangeSafeZone,BridgeNoLootZone,BridgeNoLootZone_1];  //names of triggers or area markers in editor. if empty then spawning occures everywhere
...
_civExclusiveLoot           = flatten _civNVGs + _civFirearmLoot + _item_loot + _attachment_loot + _food_loot + _civUniformLoot + _civHeadgearLoot + _civFacewearLoot + _civMagsCombined + _civFirearmLoot; //add classnames here and nothing else will be spawned
