...
/* ----------------------------------------------------------------------------
Function: JA_MISSIONGEN_fnc_findsafepos
...
Examples:
    (begin example)
        _result = [getPos player] call JA_MISSIONGEN_fnc_findsafepos;
    (end)
...
for "_i" from 0 to 4 do {
    _return_pos = [_check_pos, _mindist, _random_area, _objdist, [0, 1] select _allow_water, 60 * (pi / 180), 0,[]call JA_SafeAreaZones] call BIS_fnc_findSafePos;
